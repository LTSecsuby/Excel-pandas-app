...
def run_script(current_data, output_file_excel, output_file_html):
    ...
    # Sheet1 = Sheet1.loc[Sheet1['Дивизион'] != 'удалить из выгрузки']

    error_div = utils.check_null_pointer_in_table_value(Sheet1, 'Дивизион', 'Наименование завода', 'Пустой дивизион')
    if error_div:
